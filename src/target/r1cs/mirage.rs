...
impl<'a, F: PrimeField + PrimeFieldBits> RandomCircuit<F> for SynthInput<'a> {
        ...
        CS: RandomConstraintSystem<F>,
    {
        ...
        println!("Precomp: {:?}", precomp_time.as_fractional_secs());
        // add all constraints
    ...
    E::G2: WnafGroup,
{
    ...
    println!("Setup: {:?}", setup_time.as_fractional_secs());
    ...
    println!("Prove: {:?}", prover_time.as_fractional_secs());
    ...
    println!("Verify: {:?}", verify_time.as_fractional_secs());
